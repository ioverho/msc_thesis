...
from nmt_adapt.modules import TokenClassifier
...
class MutliTaskMorphTagTrainer(nn.Module):
    ...
    def __init__(
        ...
        self.token_clf = TokenClassifier(
            ...
            out_features=len(self.tag_to_int),
        ...
        if optimizer.lower() == "adam":
            ...
            raise NotImplementedError(
                f"Optimizer {optimizer.lower()} not implemented yet."
            )
        ...
        self.grad_clip_norm = optimizer_kwargs.get("optimizer_kwargs", torch.inf)
